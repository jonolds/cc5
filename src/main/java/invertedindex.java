...
public class invertedindex {
	...
	public static class InvIdxMapper extends Mapper<LongWritable, Text, wordpair, IntWritable> {
		HashMap<String, Integer> THEMAP;
		static final String DELIM = "!-!-!";
		
		protected void setup(Context context) { THEMAP = new HashMap<String, Integer>(); }
		...
		protected void cleanup(Context context) throws IOException, InterruptedException {
			for(Entry<String, Integer> e : THEMAP.entrySet()) {
				...
				context.write(new wordpair(key_parts[0], key_parts[1]), new IntWritable(e.getValue()));
			}
		}
	}
	
	public static class WORDFILEPartitioner extends Partitioner<wordpair, IntWritable> {
	...
	public static class InvIdxReducer extends Reducer<wordpair, IntWritable, Text, Text> {
